...
\chapter{Work, Power and Energy}
    \section{Derivation of Work and Energy: }
        ...
        \subsection{Height from Ground when Kinetic Energy is n-times the Potential Energy}
           when 
           \begin{equation}
               E_k = nE_p \implies  n = \frac{E_k}{E_p}
           \end{equation}
           where
           \begin{description}
               \item $E_k$ is the Kinetic energy
               \item $E_p$ is the Potential energy
               \item $n$ is the ratio of Kinetic energy and Potential energy
           \end{description}
            \subsubsection{For Falling and Thrown Bodies:}
                    \begin{equation}
                        x = \frac{h}{n + 1}
                    \end{equation}
                    where 
    ...
    \section{Power and Efficiency: }
        ...
        \subsection{Derivation of Efficiency: }
            \begin{equation}
                \eta = \frac{E_a}{E} = \frac{E - E_w}{E} = \frac{P_a}{P} = \frac{P - P_w}{P}
            \end{equation}
            where
            \begin{description}
                \item $\eta$ is the efficiency.
                \item $E$ is the applied energy,
                \item $E_a$ is the available energy,
                \item $E_w$ is the wasted energy,
                \item $P$ is the applied power,
                \item $P_a$ is the available power, and
                \item $P_w$ is the wasted power.
            \end{description}
